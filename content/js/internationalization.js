internationalData = [
  {
    id : "title",
    label: {
      en: "Leonardo Rebouças de Carvalho",
      pt_br: "Leonardo Rebouças de Carvalho"
    }
  },
  {
    id : "menu1",
  ...
  },
  {
    id : "phrase",
    label: {
      en: "“Daring is the spice of success!”",
      pt_br: "“A ousadia é o tempero do sucesso!”"
    }
  },
  {
    id : "subphrase",
    label: {
      en: "Inspiration, determination and focus are characteristics that turn great ideas into innovative solutions.",
      pt_br: "Inspiração, determinação e foco são caracterśiticas que transformam grandes ideias em soluções inovadoras."
    }
  },
  {
    id : "history",
    label: {
      en: "My history",
      pt_br: "Minha história"
    }
  },
  {
    id : "history-text",
    label: {
      en: ' <p class="text-white-50 mb-4">Born on May 12, 1986 in the city of Feira de Santana in Bahia, he is the son of the dealer Roberto Gomes de Carvalho and the artist Susana Rebouças da Silva. When his father passed away he was only 12 years old and had to advance his journey in the job market in the small town of Jequié, in the state of Bahia.</p>\
            <p class="text-white-50 mb-4">He started working with computer maintenance and soon started offering software development. At that time, small clipper systems for MS-DOS reigned, but already delivered applications with Windows windows developed in Delphi. In a short time, their systems were already present in several companies in the city, including markets, lotteries and pharmacies. At 17, he was hired by the largest company in the city, RAMARIM, to take care of the entire technological park of the branch in Jequié.</p>\
            <p class="text-white-50 mb-4">The following year he passed the Computer Science entrance exam at the State University of Southwest Bahia, UESB, in the city of Vitória da Conquista, where he moved. In that city he initially worked as an intern at the defunct INSS social security revenue department. Then he worked at the Faculty of Technology and Science - FTC, developing games for companies. He later accumulated work at the FTC with work at the UESB Informatics Unit, where he developed systems in Delphi and Java.</p>\
            <p class="text-white-50 mb-4">In May 2006 he passed the public exam to work at the INSS in the city of Guanambi-Ba. He took over on June 20, 2006 and worked with recognition of social security rights for 2 years in that city and then was transferred to the city of Poções-Ba, staying there for 2 more years. Then he was transferred to the logistics section of the INSS Executive Management in Vitória da Conquista.</p>\
            <p class="text-white-50 mb-4">In 2010 he graduated with a bachelor\'s degree in Computer Science. In the same year he was called by the Central Directorate of INSS, in Brasília, to join the development team of the Service Directorate, at that time working with the Supervision System. &nbsp; Between 2010 and 2014 he worked in the logistics section, working as a contract manager, with work periods in the Customer Service Department, working in the development of various systems for the INSS, with emphasis on the “Monitoring Room”, currently called HOME. </p> \
            <p class="text-white-50 mb-4">In 2014 he was invited to assume the position of Systems and Information Management Coordinator, at the INSS Benefits Directorate in Brasília, and then he moved permanently to the capital. At DIRBEN he worked in the management of the CNIS and SIBE projects, under development at Dataprev. &nbsp; The following year he was invited to assist the INSS presidency, where he served as Program Manager, coordinating the work of 6 structuring projects of the Municipality. &nbsp; The CNIS SIBE Service Portal Program intended to consolidate the INSS operational tools in a single view and culminated, among other results, in the Meu INSS application and in the digitization of various processes of the municipality. </p> \
            <p class="text-white-50 mb-4">In 2017 he was transferred to Dataprev in order to act in the area of ​​configuration management of the Infrastructure Directorate where he currently remains as manager of the Automation Division with a focus on cloud computing. </p> \
            <p class="text-white-50 mb-4">In 2020 he completed the Academic Master\'s course in Computing Science at the University of Brasilia.</p>\
            <p class="text-white-50 mb-4">In June, 2022 was born Aurora, his first doughter.</p>\
            <p class="text-white-50 mb-4">In May, 2026 he completed the Academic PhD\'s course in Computing Science at the University of Brasilia.</p>\
            ',
      
      pt_br: '<p class="text-white-50 mb-4">Nascido em 12 de maio de 1986 na cidade de Feira de Santana na Bahia é filho do comerciante Roberto Gomes de Carvalho e da artista plástica Susana Rebouças da Silva. Quando seu pai faleceu tinha apenas 12 anos e precisou adiantar sua jornada no mercado de trabalho na pequena cidade de Jequié, na Bahia.</p>\
              <p class="text-white-50 mb-4">Iniciou trabalhando com manutenção de computadores e logo passou a oferecer desenvolvimento de software. Naquela época reinavam os pequenos sistemas em clipper para MS-DOS, mas já entregava aplicativos com janelinhas do Windows desenvolvidos em Delphi. Em pouco tempo seus sistemas já estavam presentes em diversas empresas da cidade, dentre elas, mercados, lotéricas e farmácias. Aos 17 anos foi contratado pela maior empresa da cidade, a RAMARIM, para cuidar de todo o parque tecnológico da filial em Jequié.</p>\
              <p class="text-white-50 mb-4">No ano seguinte foi aprovado no vestibular de Ciências da Computação na Universidade Estadual do Sudoeste da Bahia, UESB, na cidade de Vitória da Conquista, para aonde se mudou. Naquela cidade trabalhou inicialmente como estagiário na extinta secretaria da receita previdenciária do INSS. Em seguida, trabalhou na Faculdade de Tecnologia e Ciências – FTC, desenvolvendo jogos de empresas. Mais tarde acumulou o trabalho na FTC com o trabalho na Unidade de Informática da UESB, onde desenvolvia sistemas em Delphi e Java.</p>\
              <p class="text-white-50 mb-4">Em maio de 2006 foi aprovado no concurso público para trabalhar no INSS na cidade de Guanambi-Ba. Assumiu em 20 de junho de 2006 e trabalhou com reconhecimento de direitos previdenciários por 2 anos naquela cidade e, então, foi transferido para a cidade de Poções-Ba, ficando alí mais 2 anos. Em seguida foi transferido para a seção de logística da Gerência Executiva do INSS em Vitória da Conquista.</p>\
              <p class="text-white-50 mb-4">Em 2010 formou-se bacharel em Ciência da Computação. No mesmo ano foi convocado pela Direção Central do INSS, em Brasília, para integrar a equipe de desenvolvimento da Diretoria de Atendimento, naquela época trabalhando com o Sistema Supervisão.&nbsp; Entre 2010 e 2014 intercalou períodos de trabalho na seção de logística, atuando como gestor de contratos, com períodos de trabalho na Diretoria de Atendimento, atuando no desenvolvimento de diversos sistemas para o INSS, com destaque para o “Sala de Monitoramento”, atualmente denominado CASA.</p>\
              <p class="text-white-50 mb-4">Em 2014 foi convidado para assumir o cargo de Coordenador de Gerenciamento de Sistemas e Informações, na Diretoria de Benefícios do INSS em Brasília e,então, mudou-se definitivamente para a capital. Na DIRBEN atuou na gestão dos projetos CNIS e SIBE, em desenvolvimento na Dataprev.&nbsp; No ano seguinte foi convidado para a assessoria da presidência do INSS, onde atuou como Gerente de Programa, coordenando os trabalhos de 6 projetos estruturantes da Autarquia.&nbsp; O Programa Portal de Atendimento CNIS SIBE pretendia consolidar as ferramentas operacionais do INSS em uma visão única e culminou, entre outros resultados, no aplicativo Meu INSS e na digitização de diversos processos da autarquia.</p><p class="text-white-50 mb-4">Em 2017 foi transferido para a Dataprev a fim de atuar na área de gerência de configurações da Diretoria de Infraestrutura onde permanece atualmente como gerente da Divisão de Automação como foco em computação em nuvem.</p>\
              <p class="text-white-50 mb-4">Em 2020 concluiu um Mestrado Acadêmico em Ciência da Computação pela Universidade de Brasília.</p>\
              <p class="text-white-50 mb-4">Em junho/2022 nasceu sua primeira filha, Aurora.</p>\
              <p class="text-white-50 mb-4">Em maio/2026 concluiu um Doutorado Acadêmico em Ciência da Computação pela Universidade de Brasília.</p>\
              '
    }
  },
  {
